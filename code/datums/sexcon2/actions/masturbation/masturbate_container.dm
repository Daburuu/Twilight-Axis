...
/datum/sex_action/masturbate_container/on_perform(mob/living/carbon/human/user, mob/living/carbon/human/target)
	...
	sex_session.handle_container_ejaculation(user, holding)
...
/datum/sex_action/masturbate/masturbate_container/is_finished(mob/living/carbon/human/user, mob/living/carbon/human/target)
