...
/obj/item/clothing/mask/rogue/facemask/steel/kazengun
	armor = ARMOR_PLATE
<<<<<<< HEAD:modular_twilight_axis/code/modules/clothing/rogueclothes/mask.dm
=======
...
/obj/item/clothing/head/roguetown/helmet/sallet/warden/wolf/wretch/ResetAdjust(mob/user)
	...
	if(on)
		set_light_on(FALSE)
	update_icon()
>>>>>>> f4d0d84b53bec306759b04aa5adae96fe0f9dd0e:modular_twilight_axis/code/modules/clothing/rogueclothes/mask/mask.dm
